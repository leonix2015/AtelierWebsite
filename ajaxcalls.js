...
jQuery(document).ready(function ($) {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////
    ...
    $('#update_profile').on('click',function () {
        var userorganization,useragreewithvalues,userstartingdate,userwebsite,youtube,instagram,useridimageid,useridurl,payment_info,paypal_payments_to,live_in,i_speak, usermobile, userpinterest, userlinkedin, usertwitter, userfacebook, profile_image_url, profile_image_url_small, firstname, secondname, useremail, userphone, userskype, usertitle, description, ajaxurl, securityprofile, upload_picture, useridurl, useridimageid;
        ...
        useragreewithvalues  =  $('#agree_with_values').val();
        userstartingdate  =  $('#starting_date').val();
        ...
        $.ajax({
            ...
            data: {
                ...
                'useragreewithvalues':   useragreewithvalues,
                'userstartingdate'  :   userstartingdate,
                'userskype'         :   userskype,
