...
if (!function_exists('wpestate_register_form_function')):
    ...
    function wpestate_register_form_function($attributes, $content = null) {
        ...
        if ($wp_estate_enable_user_phone == 'yes') {
            $return_string .= ' <div class="loginrow ">
                <input type="text" name="user_org_register" id="user_org_register' . $type . '" class="form-control" placeholder="' . esc_html__('Organization', 'wprentals-core') . '" size="20" />
        ...
        <label id="user_terms_register_sh_label" for="user_terms_register_sh">' . esc_html__('I agree with The Aterlier Values ', 'wprentals-core') . '<a href="' . wpestate_get_template_link('terms_conditions.php') . '" target="_blank" id="user_terms_register_topbar_link">' . esc_html__('here explained', 'wprentals-core') . '</a> </label>';
