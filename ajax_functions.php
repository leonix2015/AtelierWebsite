...
if (!function_exists('wpestate_ajax_register_form')):
    ...
    function wpestate_ajax_register_form()
    {
        ...
        $user_org     =   trim(sanitize_text_field($_POST['user_org']));
        ...
        $wp_estate_enable_user_org= esc_html ( wprentals_get_option('wp_estate_enable_user_org','') );
        if($wp_estate_enable_user_org == 'yes' && $user_org ==''){
            echo json_encode(array('register'=>false,'message'=>esc_html__('The organization field is mandatory', 'wprentals')));
            exit();
        }
...
if (!function_exists('wpestate_ajax_update_profile')):
    ...
    function wpestate_ajax_update_profile()
    {
        ...
        $user_org               = sanitize_text_field($_POST['user_org']);
